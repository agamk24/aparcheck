            ...
            <select class="form-control" id="lokasi" name="lokasi">
                ...
                <?php 
						if(count($list_lokasi) > 0){
							foreach($list_lokasi as $id_lokasi => $lokasi){
								$terpilih = '';
								if($lokasi == $id_lokasi){
									$terpilih = ' selected';
								}
								echo "<option value='$lokasi' $terpilih> $lokasi </option>";
							}
						}
            ...
            <select class="form-control" id="ukuran" name="ukuran">
                ...
                <?php 
						if(count($list_ukuran) > 0){
							foreach($list_ukuran as $id_ukuran => $ukuran){
								$terpilih = '';
								if($ukuran == $id_ukuran){
									$terpilih = ' selected';
								}
								echo "<option value='$ukuran' $terpilih> $ukuran </option>";
							}
						}
